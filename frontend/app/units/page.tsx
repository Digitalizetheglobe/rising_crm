          ...
          <div className="bg-white rounded-3xl p-4 shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center gap-4 justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="relative">
                ...
                >
                  {projectFilter}
                  <svg className={`w-4 h-4 transition-transform duration-200 ${showProjectDropdown ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" /></svg>
                </button>
                      ...
                      {(["Baner", "Kothrud", "Wakad", "Aundh"] as const).map((proj) => (
                        <button
                          ...
                          className={`w-full text-left px-3.5 py-2.5 rounded-xl transition-colors cursor-pointer flex items-center justify-between ${
                            projectFilter === proj ? "bg-brand-light text-brand font-bold" : "text-slate-600 hover:bg-slate-50"
                          }`}
                        >
                          {proj}
                        </button>
                      ...
                      <td className="py-4.5 px-6 text-center">
                        <span className={`inline-flex px-3 py-1 rounded-full text-[12px] font-bold ${
                          row.status === "Available" 
                            ? "bg-[#FFEBEB] text-[#EB3539]" 
                            : "bg-[#E6F9EE] text-[#10B981]"
                        }`}>
                          {row.status}
                        </span>
                      </td>
